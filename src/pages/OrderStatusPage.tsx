...
const OrderStatusPage = () => {
    ...
    return (
        <div className="gap-10">
            ...
            <>
                <h2 className="text-3xl font-bold text-gray-900 mb-4">{activeOrders.length} active orders</h2>
            ...
            {pastOrders.length > 0 && (
            <>
                <h2 className="text-3xl font-bold text-gray-900 mb-4">{pastOrders.length} past orders</h2>
