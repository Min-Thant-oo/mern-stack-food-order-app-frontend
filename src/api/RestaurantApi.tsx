...
export const useSearchRestaurants = (searchState: SearchState, city?: string) => {
  ...
  const { data: results, isLoading } = useQuery(
    ...
    createSearchRequest,
    { 
      enabled: !!city,   // this tells the react query to only enable this query if there is city
...
export const useGetRestaurant = (restaurantId?: string) => {
  ...
  const { data: restaurant, isLoading } = useQuery(
    ...
    {
      enabled: !!restaurantId,  // this tells the react query to only enable this query if there is restaurant id  
    }
  );
